...
room.onTeamGoal = function (team) {
  ...
  if (lastPlayersTouched[0] != null && lastPlayersTouched[0].team == team) {
    ...
    announce("☠️ [OWN GOAL] 🤡 Scorer: " + lastPlayersTouched[0].name + "", null, Cor.White, "bold");
    room.sendAnnouncement("Kick speed: " + ballSpeed.toPrecision(4).toString() + " km/h", null, Cor.White, "normal");
