...
var practiceMap = //rsi map
  `{
    ...
    "vertexes" : [
      ...
      /* 62 */ { "x" : -1221, "y" : -124, "bCoef" : 0.1, "cMask" : ["red","blue" ], "bias" : 0, "curve" : 5 },
      /* 63 */ { "x" : -1150, "y" : 124, "bCoef" : 0.1, "cMask" : ["ball","red","blue" ] },
      /* 64 */ { "x" : -1221, "y" : 124, "bCoef" : 0.1, "cMask" : ["red","blue" ], "bias" : 0, "curve" : 5 },
      /* 65 */ { "x" : -1250, "y" : -158, "bCoef" : 0, "cMask" : ["ball" ] },
      /* 66 */ { "x" : -1250, "y" : 158, "bCoef" : 0, "cMask" : ["ball" ] },
      /* 67 */ { "x" : 1150, "y" : 124, "bCoef" : 0.1, "cMask" : ["ball","red","blue" ] },
      /* 68 */ { "x" : 1221, "y" : 125, "bCoef" : 0.1, "cMask" : ["red","blue" ], "curve" : -5 },
      /* 69 */ { "x" : 1150, "y" : -124, "bCoef" : 0.1, "cMask" : ["ball","red","blue" ] },
      /* 70 */ { "x" : 1221, "y" : -123, "bCoef" : 0.1, "cMask" : ["red","blue" ], "curve" : -5 },
      ...
      /* 243 */ { "x" : 1150.0833320617676, "y" : 598.9668216705322, "cMask" : ["wall" ], "trait" : "line" },
      /* 244 */ { "x" : -1148.7167167663574, "y" : -599.833251953125, "cMask" : ["wall" ], "trait" : "line" }
    ...
    "discs" : [
      ...
      { "radius" : 2, "invMass" : 0, "pos" : [1249.75,-156.75 ], "color" : "000000", "bCoef" : 1, "trait" : "goalPost" },
...
function activateChooseMode() {
  inChooseMode = true;
  slowMode = 5;
  room.sendAnnouncement("Recruitment activated!", null, 0x55bae2, "bold");
  room.sendAnnouncement("Captain is picking players....", null, 0x55bae2, "bold");
  room.sendAnnouncement("Captain is picking players....", null, 0x55bae2, "bold")
}
...
room.onGameStart = function (byPlayer) {
  ...
  for (var i = 0; i < extendedP.length; i++) {
    ...
    // // Set team colors
    // room.setTeamColors(1, 0, 0xFFFFFF, [0xFF4041])
    // room.setTeamColors(2, 0, 0xFFFFFF, [0x2F75EB])
