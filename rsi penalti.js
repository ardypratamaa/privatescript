...
var Map = `{
	...
	"vertexes": [
		...
		},
		{
			"x": -120,
			"y": 180,
			"trait": "timebar_moving_ball_stop"
		},
		{
			"x": -120,
			"y": 120,
		...
		{
			"x": -0.16515353371088992,
			"y": 10.269012120170009,
			"trait": "line",
			"color": "6A8F59"
		},
		{
			"x": -0.06353489230201514,
			"y": -339.8362621650292,
			"trait": "line"
		},
		{
			"x": 0,
			"y": -10.395392278953913,
			"trait": "line"
		}
	],
	"segments": [
		...
		},
		{
			"v0": 24,
			"v1": 25,
			"curve": -0.6991940559700791,
			"trait": "goalnet"
		},
		{
			"v0": 25,
			"v1": 26,
			"curve": 0.38481190013627964,
			"trait": "goalnet",
			"_data": {
				"mirror": {},
				"arc": {
					...
					"curve": 0.38481190013627964,
					"radius": 29846.077114725093,
					"center": [
						-29481.04839784125,
						40.4025583144649
					],
					"from": -0.004737184242065755,
					"to": 0.0019790504161679386
				}
			}
		},
		{
		...
		},
		{
			"v0": 34,
			"v1": 35,
			"trait": "dangerZoneMinX",
			"x": -120
		},
		{
			"v0": 36,
			"v1": 37,
			"trait": "dangerZoneMaxX",
			"x": -10
		},
		{
			"v0": 34,
			"v1": 36,
			"trait": "dangerZoneMinY",
			"y": -100
		},
		{
			"v0": 35,
			"v1": 37,
			"trait": "dangerZoneMaxY",
			"y": 100
		},
		{
			"v0": 38,
	...
	"joints": [
		{ "d0" : 5, "d1" : 6, "color" : "FF0000" },
		{ "d0" : 6, "d1" : 7, "color" : "FF0000" },
		{ "d0" : 6, "d1" : 8, "color" : "FF0000" },
		{ "d0" : 9, "d1" : 10, "color" : "718C5A" },
		{ "d0" : 9, "d1" : 11, "color" : "C7E6BD", "length" : [0,240 ] },
		{ "d0" : 12, "d1" : 13, "color" : "FF0000" },
		{ "d0" : 13, "d1" : 14, "color" : "FF0000" },
		{ "d0" : 14, "d1" : 15, "color" : "FF0000" },
		{ "d0" : 12, "d1" : 15, "color" : "FF0000" },
		{ "d0" : 16, "d1" : 17, "color" : "FF4000" },
		{ "d0" : 18, "d1" : 19, "color" : "FF8000" },
		{ "d0" : 19, "d1" : 20, "color" : "FF8000" },
		{ "d0" : 20, "d1" : 21, "color" : "FF8000" },
		{ "d0" : 21, "d1" : 22, "color" : "FF8000" },
		{ "d0" : 22, "d1" : 23, "color" : "FF8000" },
		{ "d0" : 24, "d1" : 25, "color" : "FFC000" },
		{ "d0" : 25, "d1" : 26, "color" : "FFC000" },
		{ "d0" : 26, "d1" : 27, "color" : "FFC000" },
		{ "d0" : 28, "d1" : 29, "color" : "FFC000" },
		{ "d0" : 30, "d1" : 32, "color" : "FFFF00" },
		{ "d0" : 31, "d1" : 33, "color" : "FFFF00" },
		{ "d0" : 32, "d1" : 34, "color" : "FFFF00" },
		{ "d0" : 35, "d1" : 36, "color" : "C0FF00" },
		{ "d0" : 36, "d1" : 37, "color" : "C0FF00" },
		{ "d0" : 37, "d1" : 38, "color" : "C0FF00" },
		{ "d0" : 38, "d1" : 39, "color" : "C0FF00" },
		{ "d0" : 39, "d1" : 40, "color" : "C0FF00" },
		{ "d0" : 41, "d1" : 42, "color" : "80FF00" },
		{ "d0" : 42, "d1" : 43, "color" : "80FF00" },
		{ "d0" : 43, "d1" : 44, "color" : "80FF00" },
		{ "d0" : 44, "d1" : 45, "color" : "80FF00" },
		{ "d0" : 45, "d1" : 46, "color" : "80FF00" },
		{ "d0" : 47, "d1" : 48, "color" : "40FF00" },
		{ "d0" : 48, "d1" : 49, "color" : "40FF00" },
		{ "d0" : 50, "d1" : 51, "color" : "00FF00" },
		{ "d0" : 51, "d1" : 52, "color" : "00FF00" },
		{ "d0" : 52, "d1" : 53, "color" : "00FF00" },
		{ "d0" : 50, "d1" : 53, "color" : "00FF00" },
		{ "d0" : 54, "d1" : 55, "color" : "00FF00" },
		{ "d0" : 56, "d1" : 57, "color" : "00FF40" },
		{ "d0" : 57, "d1" : 58, "color" : "00FF40" },
		{ "d0" : 58, "d1" : 59, "color" : "00FF40" },
		{ "d0" : 56, "d1" : 60, "color" : "00FF40" },
		{ "d0" : 60, "d1" : 61, "color" : "00FF40" }
...
var roomName = "💠 (ʀꜱɪ) 𝗣𝗲𝗻𝗮𝗹𝘁𝘆 ᴘᴠᴘ 🧤";
var playerName = "----- ᴀᴜᴛᴏʀᴏᴏᴍ.ʀꜱɪ -----";
var noPlayer = true;
var public = true;
var maxPlayers = 20; //Varies between 2 and 30. Visit the following link to learn how to make a room for 0 or 1 person: https://github.com/thenorthstar/MineSweeperBot-HaxBall/issues/1
var token = ""; //haxball/rs/api/getheadlesstoken
var code = "id"; //2 or 3 characters code of country.
// var lat = -6.17; //Varies between -90 and 90.
// var lon = 106.85987; //Varies between -180 and 180.
var lat = 10.7747; //Varies between -90 and 90.
var lon = 106.647; //Varies between -180 and 180.
...
var championVoteKickTime = 2000; //default 10000
...
var discordLink = "https://discord.gg/pm55tVsQMX"; //Insert your discord link here.
var eliminationReasons = { nothing: 0, kickOff: 1, miss: 2, stop: 3, timeout: 4 };
var enoughPlayers = 2;
var enoughPlayersToStartMatch = 2;
var enoughTime = 300000;
var gameDelayingLimit = 100000; //600 default
...
var kickTypes = { blacklist: true, bye: false, characterLength: false, characterValidity: false, penalty: false, profane: true, spam: true, trash: false, voted: true };
...
var locales = {
    ...
    en: {
        ...
        VoteWarningMessage: "⚠️ Process Maps",
...
var messageFonts = { elimination_delay_kickoff: "normal", elimination_miss: "normal", elimination_stop: "normal", elimination_timeout: "normal", deny: "normal", warning: "normal", grant: "normal", info: "normal", announcement: "normal", welcome: "italic", goal: "normal", admin: "normal", civil: "normal" };
...
class roomObject {
    constructor() {
        ...
        this.changeFontColorIfAdmin = (player, message) => {
            if (player.admin == true) {
                room.sendAnnouncement("[💠admin] " + player.name + " [" + player.id + "]: " + message, null, messageColors.admin, messageFonts.admin, messageSounds.admin);
            }
            else {
                room.sendAnnouncement("[💠player] " + player.name + " [" + player.id + "]: " + message, null, messageColors.civil, messageFonts.civil, messageSounds.civil);
            }
            return false;
        }
...
var Commands = { //Commands with one parameter (player)
    "!setadm2542": _roomObject.get_admin,
