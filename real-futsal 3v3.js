...
room.onTeamGoal = function (team) {
  ...
  if (lastPlayersTouched[0] != null && lastPlayersTouched[0].team == team) {
    if (lastPlayersTouched[1] != null && lastPlayersTouched[1].team == team) {
      ...
      text.forEach(line => {
        room.sendAnnouncement(line, null, 0x008EE5, "small");
      });
      ...
      const text = [
        `┌──────────────────────────────────────────────────────┐`,
        `     ${goalTime} | ⚽ ɢᴏᴀʟ sᴄᴏʀᴇᴅ ʙʏ ${lastPlayersTouched[0].name} | ᴀssɪsᴛ ʙʏ - | 🟥 ${scores.red} - ${scores.blue} 🟦`,
        `└──────────────────────────────────────────────────────┘`
      ];
      text.forEach(line => {
        room.sendAnnouncement(line, null, 0x008EE5, "small");
...
Botdivulga = setInterval(function () {
  room.sendAnnouncement("🔊 Join our Discord: discord.gg/pm55tVsQMX", null, 0x5ee7ff, "normal");
}, BotdivulgaTime);
