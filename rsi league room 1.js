...
var roomName = "💠 [ʀꜱɪ|ɪᴅ] RSI League 1 | ᴘᴠᴘ ⚽";
...
function sendDiscordRecording() {
  ...
  form.append("file", new File([room.stopRecording()], `LEAGUE-R2-Replay-${getDate()}.hbr2`, { type: "text/plain" }));
...
setInterval(function () {
  room.sendAnnouncement("⭐ Community Discord: discord.gg/pm55tVsQMX ⭐", null, 0x5ee7ff, "bold", 0);
  setTimeout(function () {
